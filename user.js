...
//created table in MySQL DB
  var sql = "CREATE TABLE user (firstname VARCHAR(255), lastname VARCHAR(255),mobile int(10) ,gender VARCHAR(255),username VARCHAR(255))";
...
app.post('/user/add', (req, res) => {
    firstname= req.body.firstname, lastname = req.body.lastname, mobile = req.body.mobile, gender = req.body.gender, username = req.body.username 
      con.query("INSERT INTO `user` VALUES (firstname, lastname, mobile, gender, username)",[firstname, lastname, mobile, gender, username], (err, rows, fields) => { 
      if (!err)
